...
WebViewHandler::WebViewHandler(bool is_alloy_style)
...
void WebViewHandler::ShowMainWindow() {
  if (!CefCurrentlyOn(TID_UI)) {
    // Execute on the UI thread.
    CefPostTask(TID_UI, base::BindOnce(&WebViewHandler::ShowMainWindow, this));
    return;
  }
